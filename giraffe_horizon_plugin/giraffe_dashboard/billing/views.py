...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        calcfactor_ns2hours = 3600000000
        ...
        meter_io_w = long(
            api.get_proj_meter_record_montly_total(self.request, project,
                                                   ...
                                                   month,
                                                   year)) / calcfactor_byte2gbyte
        used_meter_io = meter_io_r + meter_io_w

        free_meter_cpu = 10000
        free_meter_io = 1020

        diff_meter_cpu = used_meter_cpu - free_meter_cpu
        diff_meter_io = used_meter_io - free_meter_io

        unit_cost_meter_cpu = 0.01
        unit_cost_meter_io = 0.01
